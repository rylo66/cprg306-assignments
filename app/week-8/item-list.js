...
export default function ItemList({ items, onItemSelect }) {
  ...
  return (
    <main className="p-8 font-extrabold flex flex-col">
      ...
      <div className="bg-gradient-to-r from-purple-200 via-pink-200 to-purple-200 flex flex-row gap-30 font-bold justify-center m-10 p-10 rounded-3xl shadow-lg shadow-purple-500 ">
      ...
      <ul className="flex justify-center-safe flex-wrap bg-gradient-to-b from-purple-200 via-pink-200 to-purple-200 rounded-3xl overflow-auto shadow-lg shadow-purple-500">
