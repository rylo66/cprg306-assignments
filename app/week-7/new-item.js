...
export default function NewItem( {onAddItem} ){
    ...
    const handleSubmit = (event) => {
        ...
        setQuantity(1),
        setCategory("Produce")
            onAddItem({id:Math.random().toString(36).substring(2, 10), name: itemName, quantity, category});
    ...
    return(
        <form className=" bg-white p-4 font-bold justify-center flex items-center flex-col" onSubmit={handleSubmit}>
            <div className=" bg-gradient-to-r from-purple-200 via-pink-200 to-purple-200 justify-center flex items-center flex-col outline-2 shadow-lg shadow-purple-500 rounded-3xl p-5 m-5">


            <div className="text-center">
                <input className="p-3 text-center text-purple-600 shadow-lg shadow-purple-500 rounded-3xl" type="text" value={itemName} onChange={handleItemNameChange} required placeholder="Click here to Add Item"></input>
            </div>
            ...
            <div className="m-2 p-2 shadow-lg shadow-purple-500 border-1 rounded-2xl">
